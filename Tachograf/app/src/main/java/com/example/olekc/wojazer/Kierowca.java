...
public class Kierowca {
    ...
    int interv = 15;            //co sekunde o tyle minut
    ...
    {
        if(czasProwadzenia >= 270 && !skroconoPrzerwe)
        {
            czasProwadzenia = 0;
            return true;
        }
        else if(czasProwadzenia >= 270 && skroconoPrzerwe)
        {
            czasProwadzenia = 0;
            skroconoPrzerwe = false;
            return true;
    ...
    {
        if(czasPrzerwy >= 15 && skroconoPrzerwe)
        {
            return true;
        }
        else if(czasPrzerwy >= 30 && !skroconoPrzerwe)
        {
            return true;
        }
        else return false;
    ...
    {
        if(calkCzasProwadzenia >= 540)
        {
            calkCzasProwadzenia = 0;
            czasProwadzenia = 0;
            return true;
        }
        else if(czasOdpoczynkuDzien == 24*60 || czasOdpoczynkuTyg == 24*60)
        {
            calkCzasProwadzenia = 0;
            czasProwadzenia = 0;
            return true;
    ...
    {
        if(czasOdpoczynku >= 180 && podzialOdpoczynku)
        {
            podzialOdpoczynku = false;
            odpoczeto_3h = true;
            return true;
        }
        else if(czasOdpoczynku >= 540 && odpoczeto_3h)
        {
            odpoczeto_3h = false;
            return true;
        }
    ...
    {
        if(calkCzasProwadzenia >= 540 && liczbaPrzedluzen <= 2)
        {
            liczbaPrzedluzen++;
            return true;
        }
    ...
    {
        if(czasPracyTyg >= 56*60 || czasPracy2Tyg >= 90*60)
        {
            czasProwadzenia = 0;
            calkCzasProwadzenia = 0;
            return true;
        }
        else if(czasOstatniegoOdpoczynku >= 6*24*60)
        {
            czasProwadzenia = 0;
            calkCzasProwadzenia = 0;
            return true;
    ...
    {
        if(czasOdpoczynku >= 24*60 && !skrocenieTyg)
        {
            return true;
        }
        else return false;
